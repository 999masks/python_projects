...
class StressTest:
	...
	def plot_mirrors(self):
		...
		# ax.plot(x_labels, m__b5, color="lavender")
		...
		# plt_mirrors.title("L16 mirror cycling test. Serial: {}".format(self.adb_device_id))
	...
	def plot_lenses(self):
		...
		# ax.plot(x_labels, l__b5, color="lavender")
...
class GUI:
	...
	def update_ui(self):
		...
		if self.test_module.is_runing:
			self.run_status.config(text="Running on: {}".format(self.test_module.adb_device_id))
