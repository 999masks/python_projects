...
class StressTest:
	...
	def calculate_possitions(self, data, mir_or_len):
		...
		mirr_mod_list_1 = ['HS1', 'B1_1', 'B2_1', 'B3_1', 'B5_1', 'C1_1', 'C2_1', 'C3_1',
		                   'C4_1']
		mirr_mod_list_2 = ['HS2', 'B1_2', 'B2_2', 'B3_2', 'B5_2', 'C1_2', 'C2_2', 'C3_2',
		                   'C4_2']
		lens_mod_list = lens_mod_list_hs1 + lens_mod_list_hs2
		mirr_mod_list = mirr_mod_list_1 + mirr_mod_list_2
